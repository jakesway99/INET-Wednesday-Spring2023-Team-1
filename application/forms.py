...
class SongEdit(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field('song1_name_artist', placeholder='1. ', css_class="form-control form-control-lg"),
            Field('song2_name_artist', placeholder='2. ', css_class="form-control form-control-lg"),
            Field('song3_name_artist', placeholder='3. ', css_class="form-control form-control-lg"),
            Field('song4_name_artist', placeholder='4. ', css_class="form-control form-control-lg"),
            Field('song5_name_artist', placeholder='5. ', css_class="form-control form-control-lg"),
...
class ArtistEdit(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field('artist1_name', placeholder='1. ', css_class="form-control form-control-lg"),
            Field('artist2_name', placeholder='2. ', css_class="form-control form-control-lg"),
            Field('artist3_name', placeholder='3. ', css_class="form-control form-control-lg"),
            Field('artist4_name', placeholder='4. ', css_class="form-control form-control-lg"),
            Field('artist5_name', placeholder='5. ', css_class="form-control form-control-lg"),
...
class AlbumEdit(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field('album1_name_artist', placeholder='1. ', css_class="form-control form-control-lg"),
            Field('album2_name_artist', placeholder='2. ', css_class="form-control form-control-lg"),
            Field('album3_name_artist', placeholder='3. ', css_class="form-control form-control-lg"),
            Field('album4_name_artist', placeholder='4. ', css_class="form-control form-control-lg"),
            Field('album5_name_artist', placeholder='5. ', css_class="form-control form-control-lg"),
